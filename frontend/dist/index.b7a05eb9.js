...
})({"3kWNu":[function(require,module,exports,__globalThis) {
...
},{"./Main.elm":"4XkAe"}],"4XkAe":[function(require,module,exports,__globalThis) {
(function(scope) {
    'use strict';
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$init = function(_v0) {
        return _Utils_Tuple2({
            ...
            foodPosition: _Utils_Tuple2(0, 0),
            snakePosition: _Utils_Tuple2(0, 0)
        }, $elm$core$Platform$Cmd$none);
    };
    ...
    var $author$project$Main$PressKey = function(a) {
        return {
            $: 'PressKey',
            a: a
        };
    ...
    var $author$project$Main$subscriptions = function(_v0) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            $elm$browser$Browser$Events$onKeyDown(A2($elm$json$Json$Decode$map, $author$project$Main$PressKey, $author$project$Main$keyDecoder)),
            $author$project$Main$messageReceiver($author$project$Main$MessageReceived)
        ]));
    };
    var $author$project$Main$Down = {
        $: 'Down'
    };
    var $author$project$Main$Left = {
        $: 'Left'
    };
    var $author$project$Main$Right = {
        $: 'Right'
    };
    var $author$project$Main$ClickPayload = function(a) {
        return {
            $: 'ClickPayload',
            a: a
        };
    ...
    var $author$project$Main$encodePosition = function(_v0) {
        var x = _v0.a;
        var y = _v0.b;
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('x', $elm$json$Json$Encode$int(x)),
            _Utils_Tuple2('y', $elm$json$Json$Encode$int(y))
        ]));
    };
    var $author$project$Main$encoderKey = function(direction) {
        switch(direction.$){
            case 'Up':
                return 'up';
            case 'Down':
    ...
    var $author$project$Main$encodePayload = function(payload) {
        if (payload.$ === 'MovePayload') {
            var position = payload.a.position;
            var direction = payload.a.direction;
            return $elm$json$Json$Encode$object(_List_fromArray([
                _Utils_Tuple2('position', $author$project$Main$encodePosition(position)),
                _Utils_Tuple2('direction', $elm$json$Json$Encode$string($author$project$Main$encoderKey(direction)))
            ]));
        } else {
            var position = payload.a.position;
            return $elm$json$Json$Encode$object(_List_fromArray([
    ...
    var $author$project$Main$encodeClickMessage = function(_v0) {
        var position = _v0.position;
        return A2($elm$json$Json$Encode$encode, 0, $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('type', $elm$json$Json$Encode$string('click')),
            _Utils_Tuple2('payload', $author$project$Main$encodePayload($author$project$Main$ClickPayload({
                position: position
            })))
        ])));
    };
    var $author$project$Main$MovePayload = function(a) {
        return {
            $: 'MovePayload',
            a: a
        };
    };
    var $author$project$Main$encodeMoveMessage = function(_v0) {
        var position = _v0.position;
        var direction = _v0.direction;
        return A2($elm$json$Json$Encode$encode, 0, $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('type', $elm$json$Json$Encode$string('move')),
            _Utils_Tuple2('payload', $author$project$Main$encodePayload($author$project$Main$MovePayload({
                direction: direction,
                position: position
            })))
        ])));
    ...
    var $author$project$Main$WebSocketMessage = F3(function(messageType, position, message) {
        return {
            message: message,
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            case 'PressKey':
                ...
                switch(key){
                    case 'ArrowUp':
                        return _Utils_Tuple2(model, $author$project$Main$sendMessage($author$project$Main$encodeMoveMessage({
                            direction: $author$project$Main$Up,
                            position: model.snakePosition
                        })));
                    case 'ArrowDown':
                        return _Utils_Tuple2(model, $author$project$Main$sendMessage($author$project$Main$encodeMoveMessage({
                            direction: $author$project$Main$Down,
                            position: model.snakePosition
                        })));
                    case 'ArrowLeft':
                        return _Utils_Tuple2(model, $author$project$Main$sendMessage($author$project$Main$encodeMoveMessage({
            ...
            case 'ClickedPosition':
                ...
                var x = _v2.a;
                var y = _v2.b;
                return _Utils_Tuple2(model, $author$project$Main$sendMessage($author$project$Main$encodeClickMessage({
                    position: _Utils_Tuple2(x, y)
                })));
            default:
                var wsMessage = msg.a;
                var _v3 = A2($elm$json$Json$Decode$decodeString, $author$project$Main$wsMessageDecoder, wsMessage);
                if (_v3.$ === 'Ok') {
                    var data = _v3.a;
                    var _v4 = data.messageType;
                    switch(_v4){
                        case 'move':
                            return _Utils_Tuple2(_Utils_update(model, {
                                snakePosition: data.position
                            }), $elm$core$Platform$Cmd$none);
                        case 'click':
                            return _Utils_Tuple2(_Utils_update(model, {
                                foodPosition: data.position
                            }), $elm$core$Platform$Cmd$none);
                        default:
                            return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                    }
    ...
    var $author$project$Main$clickDecoder = A2($elm$json$Json$Decode$map, $author$project$Main$ClickedPosition, A3($elm$json$Json$Decode$map2, $elm$core$Tuple$pair, A2($elm$json$Json$Decode$field, 'offsetX', $elm$json$Json$Decode$int), A2($elm$json$Json$Decode$field, 'offsetY', $elm$json$Json$Decode$int)));
    var $author$project$Main$view = function(model) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('container mx-auto h-screen place-content-center')
        ]), _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('bg-blue-500 mx-auto relative w-[' + ($elm$core$String$fromInt(model.area) + ('px] h-[' + ($elm$core$String$fromInt(model.area) + 'px]')))),
                A2($elm$html$Html$Events$on, 'click', $author$project$Main$clickDecoder)
            ]), _List_fromArray([
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('absolute top-[' + ($elm$core$String$fromInt(model.snakePosition.b) + ('px] left-[' + ($elm$core$String$fromInt(model.snakePosition.a) + 'px] w-10 h-10 bg-red-500'))))
                ]), _List_Nil),
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('absolute top-[' + ($elm$core$String$fromInt(model.foodPosition.b) + ('px] left-[' + ($elm$core$String$fromInt(model.foodPosition.a) + 'px] w-3 h-3 bg-green-500'))))
                ]), _List_Nil)
            ]))
        ]));
    };
...
},{}]},["3kWNu","jeorp"], "jeorp", "parcelRequire94c2")
